...
//    }
    ...
    // 3-2. 카테고리별 책 조회
    public List<BookResponseDto> getBookByCategory(Category category) {
    ...
    // 4. 특정 ID 책 수정
    public BookResponseDto updatedBook(Long id, BookRequestUpdatetDto updateDto) {
        Book book = bookRepository.findById(id)
                .orElseThrow(() -> new IllegalArgumentException("책을 찾을 수 없습니다: " + id));
